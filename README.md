...
**LIBERO-10-R** adds OOD scenarios for **LIBERO-10** and novel behavior composition tasks that combine short-horizon tasks from **LIBERO-100**. 
Building on the original [LIBERO benchmark](https://github.com/Lifelong-Robot-Learning/LIBERO), these added variations remain in the **LIBERO-10** task suite, located in ```libero/libero/bddl_files/libero_10/```. 
The OOD scenarios include 20 visual OOD scenarios and 13 novel behavior composition tasks, for a total of 43 tasks in **LIBERO-10**. In visual OOD, 10 add or replace distracting objects; 10 change the background and viewpoints.

See [Yilin Wu, Anqi Li, Tucker Hermans, Fabio Ramos, Andrea Bajcsy, Claudia Pérez-D'Arpino: Do What You Say: Steering Vision-Language-Action Models via Runtime Reasoning-Action Alignment Verification, ArXiv 2025](https://www.arxiv.org/abs/2510.16281) for more details.
...
This repository builds upon the 
...
If you found **LIBERO-10-R** usefull, please cite the following paper:
...
For the original **LIBERO**, please consider citing the paper:
